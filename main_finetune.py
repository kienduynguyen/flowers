...
from util.datasets import build_dataset, build_dataset_flowers
...
def get_args_parser():
    ...
    parser.add_argument("--resume", default="automatic", help="resume from checkpoint")
...
def main(args):
    ...
    if args.dataset == "flower":
        dataset_train = build_dataset_flowers(is_train=True, args=args)
        dataset_val = build_dataset_flowers(is_train=False, args=args)
